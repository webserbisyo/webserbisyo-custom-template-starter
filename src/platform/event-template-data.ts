...
// ---------------------------------------------------------------------------
// main_event (Ceremony / Program / Main Session)
// ---------------------------------------------------------------------------
...
export type MainEventData = CeremonyData;
...
// ---------------------------------------------------------------------------
// secondary_event (Reception / After-Party / Banquet)
// ---------------------------------------------------------------------------
...
export type SecondaryEventData = ReceptionData;
...
export type StoryMessageData = LoveStoryData;
...
export type EventTemplateData = {
  ...
  eventType?: string;
  title: string;
  coupleDisplayName: string; // Derived display representation
...
/** Backward-compatible alias for existing wedding templates */
export type WeddingTemplateData = EventTemplateData;
