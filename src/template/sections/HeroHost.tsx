...
export function HeroHostSection({ data, storyEnabled = true }: HeroHostSectionProps) {
  ...
  return (
    <section
      id="host_info"
      className="template-section section-surface-alabaster pattern-stardust-dot pattern-subtle relative isolate overflow-hidden min-h-0 pt-8 pb-14 sm:pt-10 sm:pb-16 lg:pt-10 lg:pb-12 text-[var(--debut-text-noir,#26131C)]"
    >
