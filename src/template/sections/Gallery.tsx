...
export function GallerySection({ data }: { data: GalleryData }) {
  ...
  return (
    <section
      id="gallery"
      className="template-section !pt-20 !pb-14 sm:!pt-24 sm:!pb-16 md:!pt-28 md:!pb-18 section-surface-coral bg-pattern-celestial-04 text-white text-center relative overflow-x-clip"
    >
